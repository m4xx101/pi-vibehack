...
For changes to extensions in the npm package itself (e.g., you edited `extensions/pi-vibehack/index.ts`), you'll need to restart pi or run `npx -y @m4xx101/pi-vibehack install` again so npm picks up the new package.
